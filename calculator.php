...
<body>
  ...
  <form action="calculator.php" method ="post">
    ...
    <?php
     ...
     <input type="radio" name="tip" value=<?php if($_POST["custom"]) {echo $_POST["custom"]} else {echo 0};?> <?php //if ($_POST["tip"] == ".15"){ echo "checked";}?>> <input type="text" name="custom" value = <?php if($_POST["custom"]) {echo $_POST["custom"];} else {echo 0;}; ?> >% </input>
   <!-- 15%
